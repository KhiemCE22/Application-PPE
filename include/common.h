...
inline const char* CLASS_NAMES[] = {"person","helmet","self_clothes","safety_clothes","head","blur_head","blur_clothes"};
//inline const char* CLASS_NAMES[] = {"blur_clothes","blur_head","head","helmet","person","safety_clothes","self_clothes"};
...
enum class InputSource {
    ...
    RTSP_STREAM     // Video stream through RTSP 
};
...
// ============================================================================
// Tracking Object For Tracker
// ============================================================================

/*
struct Object {
    cv::Rect_<float> rect; // [x, y, w, h]
    int label;             // obj type (0: Person, 1: Helmet, etc.)
    float score;           // conf (0.0 - 1.0)
};
*/
struct GateROI {
